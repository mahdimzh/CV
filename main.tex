...
\begin{document}
	...
	\begin{multicols}{2}
		\begin{itemize}
			\item \authorimg{Images/sbu.png} Computer Advanced Architecture \hfill[Winter 2016]
			\item \authorimg{Images/sbu.png} Fault Tolerant System \hfill[Winter 2016]
			\item \authorimg{Images/sbu.png} Data Structure \hfill[Winter 2013]
			\item \authorimg{Images/sbu.png} Operating Systems \hfill[Winter 2013]
			\item \authorimg{Images/sbu.png} Artificial Intelligence \hfill[Winter 2014]
			\item \authorimg{Images/sbu.png} Image Processing \hfill[Winter 2015]
			\item \authorimg{Images/sbu.png} Neural Networks \hfill[fall 2015]
